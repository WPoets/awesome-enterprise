...
class util
{
    ...
    public static function var_dump_plain($var, $expLevel, $depth = 0, $done = array())
    {
        ...
        if (is_bool($var)) {
			...
			$img_src="data:image/gif;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs%3D";
			$img_src="data:image/gif;base64,";

			if($setImg==1)$img_src="data:image/png;base64,";

            $html .= (!empty($var) ? ' <img id="' . $uuid . '" class="dump-img b" src="'.$img_src.'" onclick="javascript:colToggle(this.id);" style="position:relative;left:-5px;top:-1px;cursor:pointer;" /><script>setImg("' . $uuid . '",'.$setImg.',1);</script>' : '') . '<span style="color:#588bff;">array</span>(' . count($var) . ')';
            if (!empty($var)) {
            ...
            $html .= ' <img id="' . $uuid . '" class="dump-img a" src="'.$img_src.'" onclick="javascript:colToggle(this.id);" style="position:relative;left:-5px;top:-1px;cursor:pointer;"/><script>setImg("' . $uuid . '",'.$setImg.',1);</script><span style="color:#588bff;">object</span>(' . get_class($var) . ') <span id="' . $uuid . '-collapsable" style="'.$setStyle.'"><br />[<br />';

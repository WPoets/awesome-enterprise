...
function while_scalar($atts, $content=null, $shortcode = array()) {
...
// Context handler
function while_scalar_context_handler($atts, $content=null, $shortcode = array()) {
...
function scalar($atts, $content=null, $shortcode = array()) {
    \aw2\common\env\validate_context($atts, 'while_scalar:');
    $info = &\aw2_library::get_array_ref($atts['@context'], 'info');
